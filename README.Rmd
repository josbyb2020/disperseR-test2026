...
The HYSPLIT binaries in splitr are compiled for Intel. Apple Silicon Macs need
Rosetta to translate them.

1. Open **Terminal** (not R). Find it in Applications > Utilities > Terminal.
2. Run this command:
...
3. Follow the prompts to accept the license. That's it - disperseR handles the rest automatically.

**How do I know if I have Apple Silicon?** Click the Apple menu > About This Mac.
