...
The HYSPLIT binaries in splitr require an older Fortran runtime. On newer Linux 
distros (Ubuntu 22.04+), install the compatibility library:
...
Alternatively, download and compile HYSPLIT from [NOAA ARL](https://www.ready.noaa.gov/HYSPLIT.php) 
and provide `binary_path` and `parhplot_path` to bypass splitr.
