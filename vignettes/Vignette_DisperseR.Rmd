...
* `main`: the main folder where the project will be located. 
  ...
  + `output`
    ...
    * `ziplinks`: files containing ZIP code linkages
...
Note that not specifying the `location` argument will use the Desktop when available and otherwise your home directory. You can specify another folder by typing: `disperseR::create_dirs(location="/Users/username/projectlocation")` instead. 
